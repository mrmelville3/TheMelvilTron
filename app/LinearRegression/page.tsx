    ...
    return (
        <div>
            ...
            <div className="border flex flex-row">
                <div className="border w-1/2 sm:w-1/3 xl:w-1/4 2xl:w-1/3 mx-auto">
                    <MyGraph2 xMin={-50} xMax={50} yMin={-50} yMax={50} graphDataSets={noisyGraphData} uid='1' />
                    <div className="w-3/4 justify-center mx-auto my-4">
                        <Label className="mb-2">Slope (true line) {slope}</Label>
                        <Slider 
                            defaultValue={[1.0]} 
                            min={-5.0} 
                            max={5.0} 
                    ...
                    <div className="w-3/4 justify-center mx-auto my-4">
                        <Label className="mb-2">Noise Factor {noise}</Label>
                        <Slider 
                            defaultValue={[10.0]} 
                            min={0.0} 
                            max={30.0} 
                ...
                <div className="border w-1/2 sm:w-1/3 xl:w-1/4 2xl:w-1/3 mx-auto">
                    ...
                    <div className="w-3/4">
                        <Label>Estimated Slope Coefficient {estimatedSlopeCoefficient.toFixed(2)}</Label>
                    </div>
                </div>
            </div>
        </div>
